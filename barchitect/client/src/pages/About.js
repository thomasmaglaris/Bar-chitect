    ...
    <div className="whole">
      ...
      <div className="container about-body">
        <div className="about-info block">
          <section>
            <h1 className="about-header title is-1">Welcome to Bar-chitect</h1>
            <p className="font content is-large">
          ...
          <section className="block section-1">
            <h2 className="font title is-3 about-sub">
              Search for cocktails by name
            </h2>
            <b className="font content is-large">
              Do you know the name of a cocktail but not sure how to make it?
            </b>
            <br></br>
            <p className="font content is-medium">
